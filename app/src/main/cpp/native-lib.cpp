//
// Created by bilzhao on 8/4/2021.
//
#include <jni.h>
#include <string>
#include "pureCpp.h"
...
Java_com_example_javacallcppcalljava_JniApis_stringFromJNI(JNIEnv *env, jobject /* this */) {
...
Java_com_example_javacallcppcalljava_JniApis_jni2CPP(JNIEnv *env, jobject /* this */, jint msg){
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm,void* reserved){
    ...
    myClass = (env)->FindClass("com/example/javacallcppcalljava/MainActivity");
